...
function prepareAcceptedWordRecursively(currentStateObject, 
wordString, currWordLength) { 
...
|| currWordLength > 10){ 
        ...
        for (var DFAStateSymbol in currentStateObject.next) { 
            var nextDFAState = 
currentStateObject.next[DFAStateSymbol]; 
            //concatenate and extend word 
            concatenatedWord = wordString + DFAStateSymbol; 
            if(nextDFAState != null){ 
                //recursively span and loop through it. 
                prepareAcceptedWordRecursively(nextDFAState, 
concatenatedWord, currWordLength); 
            }            
        } 
    } 
